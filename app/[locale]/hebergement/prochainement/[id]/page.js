      ...
      {items.map((item, i) => (
        <div key={i} style={{ borderBottom: `1px solid ${BONE}` }}>
          <button onClick={() => setOpen(open===i?null:i)} className="w-full flex items-center justify-between py-5 text-left outline-none">
            <span className="font-serif text-[11px] uppercase tracking-[0.35em] transition-colors duration-500"
...
function InterestForm({ suite, onClose }) {
  ...
  return (
    <motion.div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center"
      ...
      onClick={onClose}>
      <motion.div className="w-full md:max-w-lg bg-[#f6f6f3] p-8 md:p-12"
        ...
        {!sent ? (
          <>
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <h3 className="font-sans font-light italic" style={{ fontSize: 'clamp(22px, 3vw, 32px)', letterSpacing: '-0.01em', color: INK }}>
                  Suite {suite.name}
                </h3>
                <p className="font-serif text-[9px] uppercase tracking-[0.40em] mt-1"
            ...
            <form onSubmit={submit} className="space-y-6">
              {[
                ...
                <div key={key} className="space-y-2">
                  <label className="block font-serif text-[9px] uppercase tracking-[0.50em]"
              ...
              <button type="submit" disabled={sending}
                className="w-full py-4 font-serif text-[11px] uppercase tracking-[0.55em] transition-all duration-500 disabled:opacity-40"
          ...
          <motion.div className="text-center py-8 space-y-5"
            ...
            <p className="font-sans font-light italic" style={{ fontSize: 'clamp(20px, 2.5vw, 28px)', letterSpacing: '-0.01em', color: INK }}>
              Merci pour votre intérêt.
            </p>
            <p className="font-serif text-[11px] uppercase tracking-[0.40em]"
              style={{ color: 'rgba(53,20,33,0.50)' }}>
              Nous vous contacterons à l'ouverture des réservations.
            </p>
            <button onClick={onClose}
              className="mt-4 font-serif text-[10px] uppercase tracking-[0.30em] pb-1"
...
function SuiteContent({ suite }) {
  ...
  const accordionItems = [
    ...
    },
    {
      label: 'Plan',
      content: (
        <p className="font-sans font-light text-[14px] leading-[1.8]" style={{ color: 'rgba(12,12,10,0.5)' }}>
          {suite.floorplan}
        </p>
      ),
    },
    {
      label: 'Adresse',
      content: (
        <p className="font-sans font-light text-[14px] leading-[1.9] whitespace-pre-line" style={{ color: 'rgba(12,12,10,0.5)' }}>
          {suite.address}
        </p>
      ),
    },
  ...
  return (
    <motion.div className="min-h-screen bg-[#f6f6f3]"
      ...
      {/* ── ENTÊTE ── */}
      <section className="max-w-[1600px] mx-auto px-6 md:px-12 pt-24 md:pt-36 pb-10 md:pb-14">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-end">
          <div>
            <div className="flex items-center gap-3 font-serif text-[9px] uppercase tracking-[0.5em] mb-8"
            ...
            <div className="flex items-center gap-3 mb-5">
              <div className="w-4 h-px" style={{ backgroundColor: WINE, opacity: 0.5 }} />
              <span className="font-serif text-[10px] uppercase tracking-[0.40em]"
            ...
            <div className="flex flex-wrap items-center gap-4" style={{ color: 'rgba(12,12,10,0.30)' }}>
              ...
              <span className="font-serif text-[10px] uppercase tracking-[0.30em]">{suite.guests} personnes max</span>
              <span className="w-px h-3" style={{ backgroundColor: 'rgba(12,12,10,0.12)' }} />
              <span className="font-serif text-[10px] uppercase tracking-[0.30em]">{suite.ambiance}</span>
            </div>
          </div>
          <div>
            <p className="font-sans font-light"
              style={{ fontSize: 'clamp(15px, 1.4vw, 19px)', lineHeight: 1.6, letterSpacing: '-0.01em', color: 'rgba(12,12,10,0.55)' }}>
              {suite.description}
            </p>
          </div>
        </div>
      ...
      <section className="max-w-[1600px] mx-auto px-6 md:px-12 pt-4 md:pt-8 pb-12 md:pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
          <R>
            <p className="font-sans font-light"
              style={{ fontSize: 'clamp(15px, 1.4vw, 19px)', lineHeight: 1.7, letterSpacing: '-0.01em', color: 'rgba(12,12,10,0.52)' }}>
            ...
            <div>
              {suite.specs.map((s, i) => (
                <div key={i} className="flex items-baseline justify-between py-4"
                  ...
                  <span className="font-serif text-[10px] uppercase tracking-[0.30em]"
      ...
      <section className="max-w-[1600px] mx-auto px-6 md:px-12 pb-12 md:pb-20">
      ...
      <section style={{ backgroundColor: INK }}>
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-16 md:py-28">
          ...
          <div className="flex items-center gap-5 mb-10 md:mb-14">
            ...
            <span className="font-serif text-[11px] uppercase tracking-[0.55em] text-white/40">
              Réservation prioritaire
            </span>
          </div>
              ...
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-between"
                ...
                <div>
                  ...
                  <div className="mb-10 pb-8" style={{ borderBottom: '1px solid rgba(12,12,10,0.06)' }}>
                    <p className="font-serif text-[9px] uppercase tracking-[0.50em] mb-3"
                      style={{ color: 'rgba(12,12,10,0.28)' }}>Suite à venir</p>
                    <h2 className="font-sans font-light italic leading-none mb-2"
                      style={{ fontSize: 'clamp(36px, 4vw, 56px)', letterSpacing: '-0.01em', color: INK }}>
                      {suite.name}
                    </h2>
                    <p className="font-serif text-[9px] uppercase tracking-[0.40em]"
                  ...
                  {/* Description */}
                  <p className="font-sans font-light leading-[1.7]"
                    style={{ fontSize: 'clamp(13px, 1vw, 15px)', color: 'rgba(12,12,10,0.45)' }}>
              ...
              <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-between bg-[#F9F8F6]">
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className="font-serif text-[9px] uppercase tracking-[0.50em]"
                      style={{ color: 'rgba(53,20,33,0.55)' }}>Accès prioritaire</span>
                  </div>
                  <h3 className="font-serif font-light leading-[1.05] mb-6"
                    style={{ fontSize: 'clamp(26px, 3vw, 42px)', letterSpacing: '-0.02em', color: INK }}>
                ...
                <button onClick={() => setFormOpen(true)}
                  className="w-full py-5 font-serif text-[11px] uppercase tracking-[0.55em] transition-all duration-500"
                  style={{ backgroundColor: INK, color: '#f6f6f3' }}
                  onMouseEnter={e => e.currentTarget.style.backgroundColor = WINE}
                  onMouseLeave={e => e.currentTarget.style.backgroundColor = INK}>
              ...
              <Link href={`/${locale}/hebergement/prochainement/${s.id}`}
                ...
                <div className="relative overflow-hidden mb-4" style={{ aspectRatio: '16/10' }}>
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="font-serif text-[9px] uppercase tracking-[0.40em] px-2 py-1"
                ...
                <div className="py-4 flex items-end justify-between">
                  <div>
                    <h3 className="font-sans font-light italic mb-1"
...
export default function SuiteProchainementPage({ params }) {
  ...
  return (
    <Suspense fallback={
      <div className="h-screen flex items-center justify-center bg-[#f6f6f3]">
